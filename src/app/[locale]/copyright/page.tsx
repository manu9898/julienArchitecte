...
export default function Copyright() {
  return (
    <div className="container">
      <p className="py-20">
        1. Présentation du site. En vertu de l’article 6 de la loi n° 2004-575
        du 21 juin 2004 pour la confiance dans l’économie numérique, il est
        précisé aux utilisateurs du site https://julien-architecte.vercel.app/fr
        l’identité des différents intervenants dans le cadre de sa réalisation
        et de son suivi :
        <br />
        <br />
        Propriétaire : Julien Blatteau – Siret – Adresse – 13001 Marseille
        Créateur : Emmanuel Muscat, Responsable publication : Emmanuel Muscat
        Webmaster : Emmanuel Muscat Hébergeur : https://vercel.com/ N° TVA
        intra-communautaire : ? Le site https://julien-architecte.vercel.app/fr
        ...
        L’utilisa
        <br />
        tion du site implique l’acceptation pleine et entière des conditions
        générales d’utilisation ci-après décrites. Ces conditions d’utilisation
        ...
        décidée sans communication préalable.
        <br />
        ...
        <br />
        <br />
        3. Description des services fournis. Le site a pour objet de fournir une
        information concernant l’ensemble des activités de la société.
        <br />
        Le responsable de publication s’efforce de fournir des informations
        ...
        renseignements figurant sur le site sont non exhaustifs. Ils sont donnés
        sous réserve de modifications ayant été apportées depuis leur mise en
        ligne.
        <br />
        <br />
        4. Limitations contractuelles sur les données techniques. Le site
        utilise la technologie JavaScript.
        <br />
        <br />
        ...
        <br />
        <br />
        5. Propriété intellectuelle et contrefaçons. Le propriétaire du site est
        propriétaire des droits de propriété intellectuelle ou détient les
        droits d’usage sur tous les éléments accessibles sur le site, notamment
        ...
        préalable du propriétaire du site.
        <br />
        <br />
        ...
        <br />
        <br />
        6. Limitations de responsabilité. Le propriétaire du site ne pourra être
        tenue responsable des dommages directs et indirects causés au matériel
        de l’utilisateur, lors de l’accès au site, et résultant soit de
        ...
        <br />
        <br />
        Le propriétaire ne pourra également être tenue responsable des dommages
        ...
        l’espace contact) sont à la disposition des utilisateurs. Le responsable
        de publication se réserve le droit de supprimer, sans mise en demeure
        ...
        relatives à la protection des données. Le cas échéant, le propriétaire
        ...
        <br />
        <br />
        7. Gestion des données personnelles. En France, les données personnelles
        sont notamment protégées par la loi n° 78-87 du 6 janvier 1978, la loi
        n° 2004-801 du 6 août 2004, l’article L. 226-13 du Code pénal et la
        Directive Européenne du 24 octobre 1995.
        <br />
        <br />
        A l’occasion de l’utilisation du site des données personnelles peuvent
        êtres recueillies : Le fournisseur d`accès de l`utilisateur L’URL des
        liens par l’intermédiaire desquels l’utilisateur a accédé au site
        L`adresse de protocole internet (IP) de l`utilisateur A l`occasion de
        l`utilisation du formulaire de contact les données personnelles
        suivantes sont recueillies :
        <br />
        <br />
        Adresse e-mail Nom et prénom Nom de l’entreprise En tout état de cause
        le site ne collecte des informations personnelles relatives à
        l’utilisateur que pour le besoin de certains services proposés par le
        site et utilise ces données uniquement dans un but d`amélioration de
        l`expérience utilisateur et afin de répondre aux demandes des
        utilisateurs.
        <br />
        <br />
        ...
        précisé à l’utilisateur du site, l’obligation ou non de fournir ces
        informations.
        <br />
        <br />
        ...
        support quelconque à des tiers. Seule l’hypothèse du rachat de la
        propriété du site et de ses droits permettrait la transmission des dites
        ...
        <br />
        <br />
        8. Liens hypertextes et cookies. Le site contient un certain nombre de
        liens hypertextes vers d’autres sites, mis en place avec l’autorisation
        du responsable de publication. Cependant, le responsable de publication
        ...
        <br />
        <br />
        La navigation sur le site est susceptible de provoquer l’installation de
        ...
        <br />
        <br />
        9. Droit applicable et attribution de juridiction. Tout litige en
        relation avec l’utilisation du site est soumis au droit français. Il est
        fait attribution exclusive de juridiction aux tribunaux compétents de
        Paris.
        <br />
        <br />
        10. Les principales lois concernées. Loi n° 78-17 du 6 janvier 1978,
        notamment modifiée par la loi n° 2004-801 du 6 août 2004 relative à
        ...
        <br />
        <br />
        11. Lexique. Utilisateur : Internaute se connectant, utilisant le site
        susnommé.
        <br />
        <br />
